...
class SetsTopBottom extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dataProduk: []
    ...
    getProduct = () => {
        axios.get(URL_API + `/products?category=${'Sets'}`)
            .then(res => {
        ...
        return (
            <div className="container my-5">
                <div className="row">
                    ...
                    <div className="col-9">
                        <h3 style={{ fontWeight: 'bold' }}>Apparels / Sets (Top & Bottom)</h3>
