...
class HijabInstan extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dataProduk: []
    ...
    getProduct = () => {
        axios.get(URL_API + `/products?category=${'Hijab Instan'}`)
            .then(res => {
        ...
        return (
            <div className="container my-5">
                <div className="row">
                    ...
                    <div className="col-9">
                        <h3 style={{ fontWeight: 'bold' }}>Hijab / Hijab Instan</h3>
